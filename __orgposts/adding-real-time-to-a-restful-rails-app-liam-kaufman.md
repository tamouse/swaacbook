...
1.  [Adding Real-Time To A RESTful Rails App - Liam Kaufman](#adding-real-time-to-a-restful-rails-app---liam-kaufman)


<a id="adding-real-time-to-a-restful-rails-app---liam-kaufman"></a>
...
>     
>     :CUSTOM<sub>ID</sub>: adding-real-time-to-a-restful-rails-app
> 
> Feb 27th, 2013
> 
...
> \*\* Starting Point
> 
> :CUSTOM<sub>ID</sub>: starting-point
> 
...
> 
> ![img](/images/rails-realtime-rest.png "Traditional RESTful Rails app")
> 
...
> 
> :CUSTOM<sub>ID</sub>: adding-real-time-with-redis-and-socket.io
> 
...
> \*\* How It Will Work
> 
> :CUSTOM<sub>ID</sub>: how-it-will-work
> 
> ![img](/images/rails-realtime-with-rt.png "Traditional RESTful Rails app with Real-Time")
> 
> 1.  When User 1 creates a new book, an "after<sub>create</sub>" callback publishes that new book to Redis on the "rt-change" channel.
...
> 
> :CUSTOM<sub>ID</sub>: socket.io-connection
> 
...
> \*\* Node Server & Pub/Sub
> 
> :CUSTOM<sub>ID</sub>: node-server-pubsub
> 
...
> \*\* Rails Models
> 
> :CUSTOM<sub>ID</sub>: rails-models
> 
...
> 
> :CUSTOM<sub>ID</sub>: listen-for-changes-in-the-backbone-app
> 
...
> 
> :CUSTOM<sub>ID</sub>: alternatives-to-the-above
> 
> **\*** SockJS
> 
> :CUSTOM<sub>ID</sub>: sockjs
> 
...
> **\*** RabbitMQ/ZeroMQ
> 
> :CUSTOM<sub>ID</sub>: rabbitmqzeromq
> 
...
> **\*** Commercial Options
> 
> :CUSTOM<sub>ID</sub>: commercial-options
> 
