...
1.  [MVC is dead, it's time to MOVE on.](#mvc-is-dead-its-time-to-move-on.)


<a id="mvc-is-dead-its-time-to-move-on."></a>
...
> -   MVC is dead, it's time to MOVE on.
>     
>     :CUSTOM<sub>ID</sub>: mvc-is-dead-its-time-to-move-on.-1
> 
...
> -   Overview
>     
>     :CUSTOM<sub>ID</sub>: overview
> 
> [[/images/move.jpg][![img](/images/move.jpg)]]
> 
